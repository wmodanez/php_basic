...
<div class="col-md-10">
    <fieldset class="hidden-print form-group">
        ...
        $result = mysqli_query($mysql, "SELECT * FROM pessoa ORDER BY id");
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            print '<tr>';
            print "<td aling='center'> <a href='pessoa_form_edit.php?txtCodigo={$id}'><i class='fa fa-edit fa-2x'></i></a></td>";
            print "<td aling='center'> <a href='pessoa_delete.php?txtCodigo={$id}'><i class='fa fa-minus-circle fa-2x' style='color: red'></i></a></td>";
            print "<td> {$id} </td>";
            print "<td> {$nome}</td>";
        ...
        <div class="col-md-4">
            <button id="btnInserir" name="btnInserir" class="btn btn-primary"
                    onclick="window.location='pessoa_form_insert.php'"><i class="fa fa-plus-circle"></i> Inserir
            </button>
        </div>
    </fieldset>
</div>
